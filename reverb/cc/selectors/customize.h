...
// public methods.
class CustomizeSelector : public ItemSelector {
 public:
 ...
 private:
  ...
  std::list<double> priorities; //versions

  //std::map<double, std::list> priority_to_indexs_;
  
  internal::flat_hash_map<double, std::vector<size_t>> priority_to_indexs_;
